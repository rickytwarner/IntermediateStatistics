...
$$
  H_0: \mu_\text{Drug 1} - \mu_\text{Drug 2} = 0
$$
$$
  H_a: \mu_\text{Drug 1} - \mu_\text{Drug 2} \neq 0
$$
...
pander(favstats(extra ~ group, data=sleep))
```
