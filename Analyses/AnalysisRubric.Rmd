...
<div style="padding-left:60px;font-size:.8em;width:80%;">
A good graphical summary should follow the "stand alone" principal. This means that the graphic communicates all the necessary information all on its own. It doesn't need added written or verbal explanations to explain what it is demonstrating.
</div>
...
<div style="padding-left:60px;font-size:.8em;width:40%;">
...before this analysis could be included in the Math 325 Notebook as an example of a very well done analysis.
</div>

**{2}** **Modest** improvements are needed...

<div style="padding-left:60px;font-size:.8em;width:40%;">
...before this analysis could be included in the Math 325 Notebook as an example of a very well done analysis.
</div>

**{3}** Very **Minor** (if any) improvements are needed...
